        ...
        return (
            <View>
                ...
                <View style={styles.viewChild}>
                    ...
                    />
                    <Text style={styles.textNomal}>{this.props.city_name}</Text>
                ...
                <View style={styles.viewChild}>
                    ...
                    />
                    <Text style={styles.textNomal}>{this.props.time_pick} - {this.props.time_drop}</Text>
                </View>
            </View>
        )
    }
        ...
        return (
            <View>
                ...
                <View style={styles.viewChild}>
                    ...
                    />
                    <Text style={styles.textNomal}>{this.props.full_name}</Text>
                </View>
                ...
                <View style={styles.viewChild}>
                    ...
                    />
                    <Text style={styles.textNomal}>{this.props.use_phone}</Text>
                </View>
                ...
                <View style={styles.viewChild}>
                    ...
                    />
                    <Text style={styles.textNomal}>{this.props.email}</Text>
                </View>
            </View>
        )
    }
