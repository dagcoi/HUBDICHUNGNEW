...
const ReducerVanChuyen = (state = defaultState, action) => {
    switch (action.type) {
        ...
        case types.PICK_ADDRESS_VANCHUYEN:
            return {
                ...state,
        ...
        case types.DROP_ADDRESS_VANCHUYEN:
            return {
                ...state,
        ...
        case types.TIME_PICK_VANCHUYEN:
            return {
                ...state,
                depart_time: action.depart_time,
        ...
        case types.ADD_PEOPLE1_VANCHUYEN:
            return {
                ...state,
        ...
        case types.ADD_PEOPLE2_VANCHUYEN:
            return {
                ...state,
        ...
        //     }
        case types.ADD_COMPANY_VANCHUYEN:
            return {
                ...state,
                xhd: action.xhd,
        ...
        case types.ADD_PROMOTION_CODE_VANCHUYEN:
            return {
                ...state,
                promotion_code: action.promotion_code,
                discount_price: action.discount_price,
            }
        case types.SWAP_ADDRESS_VANCHUYEN:
            return {
                ...state,
        ...
        case types.ADD_CITY_TIME_VANCHUYEN:
            return {
                ...state,
        ...
        case types.ADD_PAY_METHOD_ID_VANCHUYEN:
            return {
                ...state,
                pay_method_id: action.pay_method_id,
            }
        case types.ADD_COMMENT_VANCHUYEN:
            return {
                ...state,
                comment: action.comment,
            }

        case types.DELETE_DATA_VANCHUYEN:
            return {
                ...state,
                pick_add: '',
                drop_add: '',
...
export default ReducerVanChuyen;