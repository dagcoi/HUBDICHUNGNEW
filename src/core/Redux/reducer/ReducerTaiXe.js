...
const ReducerTaiXe = (state = defaultState, action) => {
    switch (action.type) {

        case types.PICK_ADDRESS_TAIXE:
            return {
                ...state,
        ...
        case types.ADD_PAY_METHOD_ID_TAIXE:
            return {
                ...state,
                pay_method_id: action.pay_method_id,
            }
        case types.ADD_COMMENT_TAIXE:
            return {
                ...state,
                comment: action.comment,
            }

        case types.DELETE_DATA_TAIXE:
            return {
                ...state,
                pick_add: '',
                drop_add: '',
