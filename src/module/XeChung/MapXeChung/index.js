...
class MapXeChung extends Component {
    ...
    nextScreen() {
        ...
        if (this.props.pick_add != '' && this.props.drop_add != '' && this.state.depart_time != '' && this.state.city_name != '') {
            if (this.props.pick_add.search(this.state.city_name) < 0 || this.props.pick_add.search(this.state.city_name) < 0) {
    ...
    render() {
        ...
        return (
            <View style={{ flex: 1, padding: 8 }}>
                ...
                <View style={{ height: 240, backgroundColor: '#ffffff', justifyContent: 'center', alignItems: 'center', borderRadius: 8, }}>
                    <View style={{ flexDirection: 'row', borderColor: '#00363e', borderWidth: 0.5, borderRadius: 8, justifyContent: 'center', alignItems: 'center' }}>
                        ...
                        >
                            <TextInput
                                editable={false}
                                onTouchStart={() => this.setState({ modalCity: true })}
