...
class MapFood extends Component {
    ...
    nextScreen() {
        // this.props.addProductChunkType('')
        this.getDateTimeAlive();
                ...
                <ImageBackground style={{ flex: 1, resizeMode: "cover", justifyContent: "center" }} source={imageBackground} >
                    ...
                    <View style={[{ flex: 1, }]} >
                        ...
                        <View style={{ justifyContent: 'center', paddingLeft: 16, marginTop: 16 }}>
                            <ImageTextBold source={require(imageCheckWhite)} textBold={"100% thực phẩm sạch"} />
...
export default connect(mapStateToProps, { addDepartTime: addDepartTime, swapAddress: swapAddress, addDuration: addDuration, addProductChunkType: addProductChunkType })(MapFood)
