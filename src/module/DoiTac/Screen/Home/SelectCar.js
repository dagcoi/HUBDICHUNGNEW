...
function SelectItem({
    ...
    return (
        <View style={styles.bntSelectItem}>
            <TouchableOpacity
                style={{ flex: 1, flexDirection: 'row', }}
                onPress={onPress}
            >
                <View style={{ width: 100, height: 100, justifyContent: 'center', alignItems: 'center', backgroundColor: backgroundColor, borderBottomLeftRadius: 8, borderTopLeftRadius: 8, }}>
                    {child}
                </View>
