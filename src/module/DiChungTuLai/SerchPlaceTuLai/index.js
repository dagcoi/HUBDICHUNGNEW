...
class SearchPlaceTuLai extends Component {
    ...
    _addPick() {
        ...
        this.props.pickAddressTuLai(address, address_component, lat, lng);
        this.goBack();
    }
...
export default connect(mapStateToProps, { dropAddressTuLai: dropAddressTuLai, pickAddressTuLai: pickAddressTuLai })(SearchPlaceTuLai)