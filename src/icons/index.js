...
function SvgDurationOver(props) {
    return (
        <View style={props.style ?? styles.styleSmall}>
            <Svg
                viewBox="0 0 24 24"
...
function SvgCalenderSelect1(props) {
    return (
        <View style={props.style ?? styles.styleSmall}>
            <Svg
                className="prefix__jss138"
                viewBox="0 0 24 24"
                aria-hidden="true"
                {...props}
            >
                <Path fill={props.color ?? colorDefault} d="M17 12h-5v5h5v-5zM16 1v2H8V1H6v2H5c-1.11 0-1.99.9-1.99 2L3 19a2 2 0 002 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2h-1V1h-2zm3 18H5V8h14v11z" />
                <Path fill="none" d="M0 0h24v24H0z" />
            </Svg>
        </View>
    )
...
function SvgInfo(props) {
    return (
        <View style={props.style ?? styles.styleSmall}>
            ...
            >
                <Path fill="none" d="M0 0h24v24H0z" />
                <Path fill={props.color ?? colorDefault} d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 15h-2v-6h2v6zm0-8h-2V7h2v2z" />
            </Svg>
        </View>
    )
}
